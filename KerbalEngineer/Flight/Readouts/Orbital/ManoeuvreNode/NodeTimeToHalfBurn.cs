...
namespace KerbalEngineer.Flight.Readouts.Orbital.ManoeuvreNode
{
    public class NodeTimeToHalfBurn : ReadoutModule
    {
        ...
        public override void Draw(Unity.Flight.ISectionModule section)
        {
            ...
            this.DrawLine(L("#KER_UI_TimeToNodeBurn", "Time to Node Burn"), TimeFormatter.ConvertToString(ManoeuvreProcessor.UniversalTime - ManoeuvreProcessor.HalfBurnTime - Planetarium.GetUniversalTime()), section);
        }
